...
> **사람이 모여야 시작되는 모임, AI가 보조하는 대학생 크라우드펀딩 플랫폼**
...
**명랑회**는 **크라우드펀딩의 개념을 대학생 모임 모집에 적용한 플랫폼**입니다.

텀블벅에서 목표 금액이 달성되어야 프로젝트가 시작되듯,

명랑회에서는 **목표 인원이 모여야 모임이 성사됩니다.**

단순한 모집 게시판이 아니라,

AI가 모임의 성사율을 높이고(카테고리 추천),
참여자의 신뢰도를 분석하며(AI 분석),
후기를 서비스의 자산으로 축적하여
...
* 🍽️ 맛집을 가고 싶지만 여러가지 이유로 같이 갈 사람이 없다.
* 👥 모임을 만들기에는 부담스럽다.
* ❌ 모집 인원이 부족해 모임이 취소된다.
